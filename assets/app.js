var magicMarvel = ["Captain America", "Thor", "Iron Man", "Black Widow", "Wolverine", "Hulk", "Deadpool", "Black Panther", "Star Lord"];
...
$("#buttonContainer").on("click", function (e) {
    if (event.target != this) {
        ...
        var queryURL = "https://api.giphy.com/v1/gifs/search?q=" +
            person + "&api_key=g63epu2bWdVI23mQ1kKiB58btNkpvA3Z&limit=10";
